  ...
  return (
    <section className="bg-[#00B0C8] lg:h-[200px] sm:h-[74px] flex items-center mt-2 md:mt-10">
      <div className="w-full max-w-[1439px] h-full mx-auto px-2 sm:px-4 lg:px-8 flex flex-col justify-center">
        <div className="flex flex-row justify-center items-center gap-x-4 sm:gap-x-10 md:gap-x-8 lg:gap-x-[260px] text-center text-white font-['Poppins']">
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[80px] sm:max-w-[100px] md:max-w-[123px] h-[20px] sm:h-[13px] md:h-[39px] font-normal text-[10px] sm:text-[8px] md:text-[22px] leading-tight flex items-center justify-center mx-auto text-white whitespace-nowrap">
              Downloads
            </div>
          </div>
          <div className="flex flex-col items-center">
