      ...
      <div className="max-w-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-0 items-center lg:-ml-[24px]">
          ...
          <div className="order-1 lg:order-2 font-['Poppins'] max-w-[703px] flex flex-col items-start justify-center text-left lg:-ml-16">
            ...
            <button className="w-[200px] sm:w-[354px] md:w-[295px] h-[60px] sm:h-[43px] md:h-[80px] rounded-full bg-[#00B0C8] text-white flex items-center justify-center hover:bg-cyan-600 transition-colors">
